...
Clear();
    ...
    void swap(SingleLinkedList& other) noexcept {
        auto temp = other.size_;
        other.size_ = size_;
        size_ = temp;
        auto temp2 = other.head_.next_node;
    ...
    // pos.node_->next_node это адрес следующей за pos ноды, записанный как next_node
    ...
    /*
     void PopFront() noexcept {
         auto temp = head_.next_node->next_node; запоминаем указатель на то шо за удаляемым
         delete head_.next_node; удаляем
         head_.next_node = temp; переписываем указатель на следующий
     }
     */
    ...
    */
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        delete pos.node_->next_node; // есть
        pos.node_->next_node = temp;
        if (size_ > 0)
            --size_;
        return Iterator{temp};
